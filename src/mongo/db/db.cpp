...
/*tdnguyen*/
#ifdef TDN_RID
//for tracking rid write
FILE* my_fp_rid;
FILE* my_fp_ssdm;
struct timeval  my_tv2;
...
int main(int argc, char* argv[], char** envp) {
	...
	my_fp = fopen("my_io_track.txt", "a");
	my_fp2 = fopen("my_func_track.txt", "a");
#ifdef TDN_LOG
	my_fp_log = fopen("my_track_log.txt", "a");
#endif
...
#ifdef TDN_TRACK_PID 
	my_fp3 = fopen("my_reconcile_track.txt", "a");
	printf("======== > Hello, Track pid mode\n");
#endif

#ifdef TDN_RID
	my_fp_rid = fopen("my_track_rid.txt", "a");
	my_fp_ssdm = fopen("my_track_ssdm.txt", "a");
...
#ifdef SSDM_OP3
	printf("======== > OP3: stream-id by read_gen\n");
#endif
